...
class V8_EXPORT GcStatistics {
 public:
  GcStatistics();
  size_t total_gc_time_ms() { return total_gc_time_ms_; }
  size_t total_scavenge_time_ms() { return total_scavenge_time_ms_; }
  size_t total_marksweep_time_ms() { return total_marksweep_time_ms_; }
 private:
  size_t total_gc_time_ms_;
  size_t total_scavenge_time_ms_;
  size_t total_marksweep_time_ms_;
 ...
 * get heap statistics from V8.
 */
class V8_EXPORT AlinodeHeapStatistics {
 public:
  AlinodeHeapStatistics();
  size_t total_heap_size() { return total_heap_size_; }
  size_t total_heap_size_executable() { return total_heap_size_executable_; }
  size_t total_physical_size() { return total_physical_size_; }
  size_t total_available_size() { return total_available_size_; }
  ...
  size_t memory_allocator_used() {return memory_allocator_used_; }
  size_t memory_allocator_available() {return memory_allocator_available_; }
  size_t new_space_size() {return new_space_size_; }
  size_t new_space_used() {return new_space_used_; }
  size_t new_space_available() {return new_space_available_; }
  size_t new_space_committed() {return new_space_committed_; }

  size_t old_space_size() {return old_space_size_; }
  size_t old_space_used() {return old_space_used_; }
  size_t old_space_available() {return old_space_available_; }
  size_t old_space_committed() {return old_space_committed_; }

  size_t code_space_size() {return code_space_size_; }
  size_t code_space_used() {return code_space_used_; }
  size_t code_space_available() {return code_space_available_; }
  size_t code_space_committed() {return code_space_committed_; }
  size_t map_space_size() {return map_space_size_; }
  size_t map_space_used() {return map_space_used_; }
  size_t map_space_available() {return map_space_available_; }
  size_t map_space_committed() {return map_space_committed_; }

  size_t lo_space_size() {return lo_space_size_; }
  size_t lo_space_used() {return lo_space_used_; }
  size_t lo_space_available() {return lo_space_available_; }
  size_t lo_space_committed() {return lo_space_committed_; }
  size_t heap_available() {return heap_available_; }
  size_t amount_of_external_allocated_memory() {
    return (size_t)amount_of_external_allocated_memory_;
  }
...
class V8_EXPORT Isolate {
 public:
  ...
  /**
  * 当在线tracGC的时候,需要将第一列的pid去掉.
  */
  void SetOnLineTraceFlag(bool is_online_trace);

  /**
  * 启动在线gc-trace
  */
  void OnLineGCStart(char* gc_log_file);
  ...
  */
  ...
  /**
  * 启动在线prof/basic_prof/ll_prof
  */
  void OnLineTraceStart(bool is_online_trace);

  /**
  * 停止在线prof/basic_prof/ll_prof
  */
  void OnLineTraceStop();

  /**
  * Get statistics about GC.
  */
  void GetGcStatistics(GcStatistics* gc_stat);

  /**
  * print gc ring buffer
  */
  void PrintGcRingBuffer();

  void SetRegexpLogFile(char* log_file);

  long GetRegexpExecTime();

  void LogVeryLongTimeRegexp(char* prefix);
  ...
  void GetHeapStatistics(AlinodeHeapStatistics* heap_statistics);
...
class V8_EXPORT V8 {
 public:
  ...
  static bool GetBoolFlagByName(const char* str, bool* value);
